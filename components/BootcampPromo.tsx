...
export default function BootcampPromo() {
  ...
  return (
    <>
      ...
      {showBanner && (
        <div className="relative z-[60] w-full max-w-full overflow-hidden border-b border-white/10 bg-[#150a33] text-white">
          {/* subtle grid */}
          <div
            aria-hidden="true"
          ...
          />
          <div className="relative mx-auto flex w-full max-w-6xl flex-wrap items-center justify-center gap-2 px-3 py-2 pr-10 text-center sm:gap-3 sm:px-6 sm:py-2.5 sm:pr-12">
            ...
            <p className="flex min-w-0 flex-1 flex-wrap items-center justify-center gap-x-1.5 gap-y-1 text-[11px] font-medium leading-tight sm:flex-none sm:text-sm sm:leading-none">
              <span className="whitespace-nowrap font-semibold">7-Days Agentic AI Bootcamp</span>
              <span className="hidden text-white/40 sm:inline">—</span>
              <span className="whitespace-nowrap text-white/80">Build your first AI agent in 7 days</span>
              <span className="inline-flex shrink-0 items-center gap-1">
                <span className="text-white/50 line-through">₹599</span>
                <span className="font-bold text-white">₹299</span>
                <span className="shrink-0 rounded-full bg-white px-1.5 py-0.5 text-[10px] font-bold tracking-wide text-[#ff4d6a]">50% OFF</span>
              </span>
            </p>
            <Link
            ...
            <Link
              href="/training/agentic-ai-bootcamp"
              onClick={() => dismissModal(false)}
              className="inline-flex shrink-0 rounded-full bg-white px-3 py-1 text-[11px] font-semibold text-ink sm:hidden"
            >
              Enroll →
            </Link>
            <button
              ...
              className="absolute right-1 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 text-white/70 transition hover:bg-white/20 hover:text-white sm:right-3"
            >
